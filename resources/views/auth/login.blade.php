        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                               ...
                               @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" id="email" name="email" placeholder="Ingrese Correo Electronico" value="{{ old('email') }}"
                                     class="form-control pe-5 @error('email') is-invalid @enderror" required autofocus>
                ...
                <div class="mt-4 text-center">
                    <p class="mb-0">¿No, Tienes Cuenta ? <a href="{{ route('register') }}" class="fw-semibold text-primary text-decoration-underline"> Registrate </a> </p>
                </div>
